...
//   console.log("RT_DATA", returned_data)
//   updateReactomePathway(returned_data.pathway_id, returned_data.pathway_name, returned_data.reactome_token)
// };
...
//
//   updateReactomePathway(returned_data.reactome_id, returned_data.pathway_name, returned_data.reactome_token)
//
// };

// const url = `/met_explore/metabolite_pathway_data/R-DME-1237112`
// fetch(url)
// .then(res => res.json())//response type
// .then(handleUpdate);
...
$(document).ready(function() {
  ...
  //   // Handle error as necessary
   console.log("waiting on metabolite to be passed, caught", e);
    }
  }
}
  //
