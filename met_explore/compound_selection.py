...
class CompoundSelector(object):
    ...
    def get_single_cmpd_df(self):
        ...
        compound_ids = self.int_df['cmpd_id'].tolist()
    ...
    def add_preferred_annotations(self):
        """
        ...
        peaks_ids = self.single_cmpds_df.index.values
        cmpd_ids = self.single_cmpds_df.cmpd_id.values
