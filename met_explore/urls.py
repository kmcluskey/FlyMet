...
urlpatterns = [
    ...
    path('peak_mf_compare/<str:peak_mf_list>', c(views.peak_mf_compare), name='peak_mf_compare'),
    ...
    path('peak_mf_compare_data/<str:peak_mf_list>', c(views.peak_mf_compare_data), name='peak_mf_age_data'),
