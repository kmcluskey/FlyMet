# Generated by Django 3.1.3 on 2021-02-28 20:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=250, unique=True)),
                ('group', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='met_explore.group')),
            ],
        ),
        migrations.CreateModel(
            name='UniqueToken',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=250, unique=True)),
                ('description', models.CharField(max_length=500)),
                ('project', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='met_explore.project')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='case_group', to='met_explore.group')),
                ('control_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='control_group', to='met_explore.group')),
            ],
        ),
        migrations.AddField(
            model_name='analysis',
            name='category',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='met_explore.category'),
        ),
    ]
