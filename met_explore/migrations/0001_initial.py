# Generated by Django 2.1.7 on 2019-06-19 14:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chebi_id', models.CharField(max_length=30, null=True)),
        ...
        migrations.AddField(
            model_name='compounddbdetails',
            name='db_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='met_explore.DBNames'),
        ),
        migrations.AddField(
            model_name='compound',
            name='peaks',
